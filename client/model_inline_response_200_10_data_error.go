...
// InlineResponse20010DataError struct for InlineResponse20010DataError
type InlineResponse20010DataError struct {
...
func NewInlineResponse20010DataError() *InlineResponse20010DataError {
	this := InlineResponse20010DataError{}
	return &this
}
...
func (o InlineResponse20010DataError) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20010DataError struct {
	value *InlineResponse20010DataError
	isSet bool
}

func (v NullableInlineResponse20010DataError) Get() *InlineResponse20010DataError {
	return v.value
}

func (v *NullableInlineResponse20010DataError) Set(val *InlineResponse20010DataError) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20010DataError) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20010DataError) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20010DataError(val *InlineResponse20010DataError) *NullableInlineResponse20010DataError {
	return &NullableInlineResponse20010DataError{value: val, isSet: true}
}

func (v NullableInlineResponse20010DataError) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20010DataError) UnmarshalJSON(src []byte) error {
	v.isSet = true

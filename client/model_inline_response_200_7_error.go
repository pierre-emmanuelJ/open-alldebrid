...
// InlineResponse2007Error struct for InlineResponse2007Error
type InlineResponse2007Error struct {
...
func (o InlineResponse2007Error) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2007Error struct {
	value *InlineResponse2007Error
	isSet bool
}

func (v NullableInlineResponse2007Error) Get() *InlineResponse2007Error {
	return v.value
}

func (v *NullableInlineResponse2007Error) Set(val *InlineResponse2007Error) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2007Error) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2007Error) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2007Error(val *InlineResponse2007Error) *NullableInlineResponse2007Error {
	return &NullableInlineResponse2007Error{value: val, isSet: true}
}

func (v NullableInlineResponse2007Error) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2007Error) UnmarshalJSON(src []byte) error {
	v.isSet = true

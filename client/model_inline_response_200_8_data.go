...
type InlineResponse2008Data struct {
	...
	Streams *[]InlineResponse2008DataStreams `json:"streams,omitempty"`
}
...
// and a boolean to check if the value has been set.
func (o *InlineResponse2008Data) GetLinkOk() (*string, bool) {
	if o == nil || o.Link == nil {
		return nil, false
	}
	return o.Link, true
...
func (o *InlineResponse2008Data) GetStreams() []InlineResponse2008DataStreams {
	if o == nil || o.Streams == nil {
		var ret []InlineResponse2008DataStreams
		return ret
	}
	return *o.Streams
}
...
// SetStreams gets a reference to the given []InlineResponse2008DataStreams and assigns it to the Streams field.
func (o *InlineResponse2008Data) SetStreams(v []InlineResponse2008DataStreams) {
	o.Streams = &v
}

func (o InlineResponse2008Data) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2008Data struct {
	value *InlineResponse2008Data
	isSet bool
}

func (v NullableInlineResponse2008Data) Get() *InlineResponse2008Data {
	return v.value
}

func (v *NullableInlineResponse2008Data) Set(val *InlineResponse2008Data) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2008Data) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2008Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2008Data(val *InlineResponse2008Data) *NullableInlineResponse2008Data {
	return &NullableInlineResponse2008Data{value: val, isSet: true}
}

func (v NullableInlineResponse2008Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2008Data) UnmarshalJSON(src []byte) error {
	v.isSet = true

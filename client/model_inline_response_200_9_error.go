...
// InlineResponse2009Error struct for InlineResponse2009Error
type InlineResponse2009Error struct {
...
func (o InlineResponse2009Error) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse2009Error struct {
	value *InlineResponse2009Error
	isSet bool
}

func (v NullableInlineResponse2009Error) Get() *InlineResponse2009Error {
	return v.value
}

func (v *NullableInlineResponse2009Error) Set(val *InlineResponse2009Error) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse2009Error) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse2009Error) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse2009Error(val *InlineResponse2009Error) *NullableInlineResponse2009Error {
	return &NullableInlineResponse2009Error{value: val, isSet: true}
}

func (v NullableInlineResponse2009Error) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse2009Error) UnmarshalJSON(src []byte) error {
	v.isSet = true

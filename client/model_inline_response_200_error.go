...
// InlineResponse200Error struct for InlineResponse200Error
type InlineResponse200Error struct {
...
func (o InlineResponse200Error) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse200Error struct {
	value *InlineResponse200Error
	isSet bool
}

func (v NullableInlineResponse200Error) Get() *InlineResponse200Error {
	return v.value
}

func (v *NullableInlineResponse200Error) Set(val *InlineResponse200Error) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse200Error) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse200Error) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse200Error(val *InlineResponse200Error) *NullableInlineResponse200Error {
	return &NullableInlineResponse200Error{value: val, isSet: true}
}

func (v NullableInlineResponse200Error) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse200Error) UnmarshalJSON(src []byte) error {
	v.isSet = true

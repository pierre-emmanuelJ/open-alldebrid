...
func (o InlineResponse20018Data) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20018Data struct {
	value *InlineResponse20018Data
	isSet bool
}

func (v NullableInlineResponse20018Data) Get() *InlineResponse20018Data {
	return v.value
}

func (v *NullableInlineResponse20018Data) Set(val *InlineResponse20018Data) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20018Data) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20018Data) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20018Data(val *InlineResponse20018Data) *NullableInlineResponse20018Data {
	return &NullableInlineResponse20018Data{value: val, isSet: true}
}

func (v NullableInlineResponse20018Data) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20018Data) UnmarshalJSON(src []byte) error {
	v.isSet = true

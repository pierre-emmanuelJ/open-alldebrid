...
// InlineResponse20013Error struct for InlineResponse20013Error
type InlineResponse20013Error struct {
...
func (o InlineResponse20013Error) MarshalJSON() ([]byte, error) {
...
type NullableInlineResponse20013Error struct {
	value *InlineResponse20013Error
	isSet bool
}

func (v NullableInlineResponse20013Error) Get() *InlineResponse20013Error {
	return v.value
}

func (v *NullableInlineResponse20013Error) Set(val *InlineResponse20013Error) {
	v.value = val
	v.isSet = true
}

func (v NullableInlineResponse20013Error) IsSet() bool {
	return v.isSet
}

func (v *NullableInlineResponse20013Error) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInlineResponse20013Error(val *InlineResponse20013Error) *NullableInlineResponse20013Error {
	return &NullableInlineResponse20013Error{value: val, isSet: true}
}

func (v NullableInlineResponse20013Error) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInlineResponse20013Error) UnmarshalJSON(src []byte) error {
	v.isSet = true
